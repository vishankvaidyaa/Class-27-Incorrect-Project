...
function setup(){
    ...
    ground = new Ground(600,height,1200,20);
     ...
     paper1 = new Paper(200, 720, 40, 40);
     paper2 = new Paper(200, 750, 40, 40);
     paper3 = new Paper(200, 780, 40, 40);
     paper4 = new Paper(200, 800, 40, 40);
     paper5 = new Paper(200, 830, 40, 40);
